...
plot(c(0, length), c(0,nrow(narr_data)), col = "white", xlab = "Time (seconds)", ylab = "", main = title, axes=FALSE)
...
size_bins = 10;
hist(long$Reaction.Time, main="", xlab="Time (seconds)", xlim=c(0,length), breaks=length/size_bins)
